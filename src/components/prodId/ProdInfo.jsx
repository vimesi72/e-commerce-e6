    ...
    <article className="prodinfo">
      ...
      <div className="prodinfo_container">
        ...
        <div className="prodinfo__counter">
          <p>quantity</p>
          <button onClick={handleLess} className="prodinfo__btnless">
            -1
          </button>
          <span>{counter}</span>
          <button onClick={handlePlus} className="prodinfo__btnplus">
            +1
          </button>
        </div>
      </div>
      <button onClick={handleBuy} className="prodinfo_btnbuy">
        Add to cart
      </button>
    </article>
  );
